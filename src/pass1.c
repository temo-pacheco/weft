...
/* {60: literate/parser.weft:349} */

                                  /* Perhaps skip white-space */
                                  
#line 355 "literate/parser.weft"
                                  /* {61: literate/parser.weft:355} */
if (c == ' ')
                                  {
                                     while (source_peek == ' ')
                                        c = source_get();
...
#line 99 "literate/parser.weft"
                      /* {44: literate/parser.weft:99} */
collect_weave_format();/* {:44} */
