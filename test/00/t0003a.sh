...
\WEFTcode
\mbox{\strut}File\WEFTsp defining\WEFTsp fred\WEFTsp and\WEFTsp jim.\WEFTbrk \WEFTeol
\mbox{\strut}\WEFTeol
\mbox{\strut}See?\WEFTsp \WEFTsp \WEFTeol
\mbox{\strut}{\WEFTsep}\WEFTendcode
\vspace{-1.5ex}
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \WEFTtxtIdentsDefed\nobreak\  \verb@fred@\nobreak\ \WEFTtxtIdentsNotUsed, \verb@jim@\nobreak\ \WEFTtxtIdentsNotUsed.
\item{}
\end{list}
\WEFTend
\end{document}
