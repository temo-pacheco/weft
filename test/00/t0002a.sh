...
\WEFTbegin
\label{scrap1}
\WEFTtarget{weft?}{} $\langle\,${\itshape Test \hbox{\slshape\sffamily param\/} in index}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\WEFTcode
\mbox{\strut}Param\WEFTsp \hbox{\slshape\sffamily param\/}\WEFTsp here\WEFTeol
...
\item $\langle\,$Test \hbox{\slshape\sffamily param\/} in index\nobreak\ {\footnotesize \WEFTlink{weft?}{?}}$\,\rangle$ {\footnotesize {\WEFTtxtNoRef}.}
\end{list}}
EOF
