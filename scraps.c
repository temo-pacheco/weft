...
/* {297: literate/scraps.weft:691} */
int delayed_indent = 0;
/* {:297} */

#line 695 "literate/scraps.weft"
/* {298: literate/scraps.weft:695} */
...
/* {395: literate/search-labels.weft:394} */
...
/* {372: literate/search-labels.weft:11} */
...
/* {373: literate/search-labels.weft:18} */
...
/* {374: literate/search-labels.weft:27} */
...
/* {375: literate/search-labels.weft:35} */
...
/* {376: literate/search-labels.weft:42} */
...
/* {377: literate/search-labels.weft:57} */
...
/* {378: literate/search-labels.weft:67} */
...
/* {379: literate/search-labels.weft:75} */
static void
...
/* {380: literate/search-labels.weft:93} */
...
#line 111 "literate/search-labels.weft"
      /* {381: literate/search-labels.weft:111} */
if (a->pv != NULL)
      {
         char c = *a->pv++;
...
#line 127 "literate/search-labels.weft"
      /* {382: literate/search-labels.weft:127} */
if (a->arg) {
         Arglist * b = a->arg;
...
#line 140 "literate/search-labels.weft"
      /* {383: literate/search-labels.weft:140} */
} else {
         mgr->a = a->old;
         free(a);
      }/* {:383} */
...
/* {384: literate/search-labels.weft:146} */
static char
...
#line 164 "literate/search-labels.weft"
      /* {385: literate/search-labels.weft:164} */
...
#line 182 "literate/search-labels.weft"
      /* {386: literate/search-labels.weft:182} */
int k = m->index - n - 2;
...
/* {388: literate/search-labels.weft:197} */
...
#line 281 "literate/search-labels.weft"
  /* {391: literate/search-labels.weft:281} */
{
    int depth;
...
#line 318 "literate/search-labels.weft"
  /* {392: literate/search-labels.weft:318} */
{
    for (i=1; i<scraps; i++) {
      char c, last = '\0';
      Manager rd;
...
#line 365 "literate/search-labels.weft"
        /* {393: literate/search-labels.weft:365} */
...
#line 373 "literate/search-labels.weft"
        /* {394: literate/search-labels.weft:373} */
if (last == nw_char && c == '<')
        {
...
/* {389: literate/search-labels.weft:218} */
static void build_gotos(Name *tree)
{
  while (tree) {
...
#line 229 "literate/search-labels.weft"
    /* {390: literate/search-labels.weft:229} */
{
      int depth = 2;
...
/* {396: literate/search-labels.weft:400} */
...
/* {397: literate/search-labels.weft:413} */
...
/* {400: literate/search-labels.weft:444} */
...
#line 455 "literate/search-labels.weft"
    /* {401: literate/search-labels.weft:455} */
{
      char join = ' ';
...
#line 467 "literate/search-labels.weft"
        /* {402: literate/search-labels.weft:467} */
Name * name = p->defn;
...
#line 488 "literate/search-labels.weft"
            /* {403: literate/search-labels.weft:488} */
...
/* {405: literate/search-labels.weft:499} */
...
#line 510 "literate/search-labels.weft"
    /* {406: literate/search-labels.weft:510} */
{
      char join = ' ';
...
#line 522 "literate/search-labels.weft"
        /* {407: literate/search-labels.weft:522} */
Name * name = p->defn;
...
/* {408: literate/search-labels.weft:554} */
...
/* {409: literate/search-labels.weft:570} */
static int reject_match(Name *name, char post, ArgManager *reader)
{
...
/* {411: literate/search-labels.weft:600} */
void
...
/* {419: literate/search-labels.weft:639} */
{
   label_node * * plbl = &label_tab;
   for (;;)
   {
...
#line 610 "literate/search-labels.weft"
            /* {413: literate/search-labels.weft:610} */
write_single_scrap_ref(file, lbl->scrap);
            fprintf(file, "-%02d", lbl->seq);/* {:413} */
...
#line 614 "literate/search-labels.weft"
          /* {414: literate/search-labels.weft:614} */
